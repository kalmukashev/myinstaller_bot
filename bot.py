...
def create_keyboard3():
	keyboard = types.InlineKeyboardMarkup()
	acmp_btn = types.InlineKeyboardButton(text = "Школа Программиста", url="https://acmp.ru")
...
def get_download(message):
	...
	if message.text == '/help':
		bot.send_message(message.chat.id, "1 Команда: Напиши Привет\n2 Команда: Напиши Скачать или скачать\n3 Команда: Напиши Ссылки или ссылки\n4 Команда: Напиши Задачи или задачи")
